...
class m_RoIDataLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        if cfg.TRAIN.BBOX_REG_3d:
            ...
            self._name_to_top_map['bvimg'] = 6
            self._name_to_top_map['rois_bv'] = 7
            # depth map blob:
            ...
            # bv map blob:
            top[6].reshape(1, 3, 100, 100)

            # bv rois blob:
            top[7].reshape(1, 5)

        #self._name_to_top_map['rois_context'] = 8
        #self._name_to_top_map['rois_context_bv'] = 9
        #top[8].reshape(1, 5)
        #top[9].reshape(1, 5)
